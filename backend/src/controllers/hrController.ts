...
export const postOnboard = async (req: any, res: Response) => {
  try {
...
export const listLeaves = async (req: any, res: Response) => {
  try {
...
export const patchLeave = async (req: any, res: Response) => {
  try {
    const { id } = req.params;
